...
""" Concrete model for the astronomical Object: Asteroid

Using this class allows for a structured implementation of
a solar system. With this class, you can build asteroid fields
among other things. The default values come from the popular
asteroid Ceres.

See: https://en.wikipedia.org/wiki/Ceres_(dwarf_planet)
"""
...
class Asteroid(AstronomicalObject):
    def __int__(self, name = "Asteroid", texture = None, period_of_orbit = 1680, radius_of_orbit = 414010000, radius_of_object = 477):
        """
